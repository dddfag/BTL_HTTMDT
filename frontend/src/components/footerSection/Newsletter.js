...
export const Newsletter = () => {
  return (
    <section className="mt-16 py-8 px-6 tablet:px-[5%] lg:w-[50%] xs:[40%] w-[92%] tablet:w-[75%] md:w-[60%] mx-auto bg-primaryColor text-white rounded-md z-10 sticky">
      <h2 className="font-bold text-[24px] text-center">Hãy tin tưởng chúng tôi!</h2>
      <p className="mt-6 font-medium text-center">
        Để nhận được thông tin về các sản phẩm mới nhất, ưu đãi đặc biệt và các cập nhật khác, hãy gửi thông tin liên hệ đến chúng tôi. Mọi thắc mắc sẽ được giải đáp nhanh chóng và tận tình.
      </p>
