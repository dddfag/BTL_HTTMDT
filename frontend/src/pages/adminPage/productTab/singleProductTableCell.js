  ...
  return (
    <>
      ...
      <tr className="hover:bg-lightestSecondaryColor cursor-pointer" onClick={handleShowProductDetails}>
        <td className="p-2 border border-b-0 border-LightSecondaryColor max-w-[120px] truncate" title={_id}>{_id}</td>
        <td className="p-2 border border-b-0 border-LightSecondaryColor w-20">
          <img 
            src={products.image} 
            alt={title} 
