...
const Index = () => {
  ...
  return (
    <section className="lg:grid lg:grid-cols-[250px_1fr_1fr_1fr] lg:grid-rows-[auto_1fr_auto]">
      <div className="mt-12 tablet:px-[6%] w-[100%] h-auto bg-neutralColor text-secondaryColor xl:px-[4%] px-[4%] lg:px-[2%] flex items-center justify-between font-bold py-6 font-RobotoCondensed lg:col-span-full lg:row-span-1">
