  ...
  if (isTokenValidLoader) {
    ...
    return (
      <>
        ...
        <div className="absolute top-24 right-[4%] md:right-[4%] lg:right-[2%] xl:right-[4%] tablet:right-[6%]">
          <div
        ...
        <div className="flex mx-[4%] justify-start gap-6 mt-16 md:mx-[4%] lg:mx-[2%] xl:mx-[4%] tablet:mx-[6%]">
          <article className="w-[50%] tablet:w-[35%] lg:w-[30%] md:w-[30%] bg-[#ffffff] max-w-[264px] mb-16 flex-col flex gap-2 flex-shrink-0">
            <div
