...
const { registerUser, loginUser, deleteUser, getUserDataById, getAllUsers, updateUserSettings } = require("../controllers/userAuthentication");
...
router.route("/getUserData").get(getUserDataById);
router.route("/getAllUsers").get(checkIfUserIsAnAdminMiddleware, getAllUsers);
...
router.route("/updateUserSettings").put(updateUserSettings);
